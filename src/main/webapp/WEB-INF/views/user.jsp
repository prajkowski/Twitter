...
<body>
<div class="container">
    <h3 class="header">Dodaj użytkownika</h3>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form:input type="hidden"
                                value="https://www.qualiscare.com/wp-content/uploads/2017/08/default-user.png"
                                path="imageUrl" id="imageUrlId" class="form-control"/>
